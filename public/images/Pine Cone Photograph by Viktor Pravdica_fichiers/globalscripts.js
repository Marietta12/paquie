    ...
    function showGlobalForegroundAndBackgroundDiv()
    {
        ...
        foregroundDiv.innerHTML = "<img src='/Searching.gif' style='display: inline-block; margin-top: 20px;'>";
    ...
    function globalSubmitEmailSubscription()
    {
        ...
        document.getElementById('submitsubscriptionDiv').innerHTML = "<img src='/Searching.gif' style='display: inline-block; padding-top: 5px;'>";
