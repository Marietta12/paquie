...
function bringtotop(artworkid,status)
    ...
    function favoriteimage(artworkid)
    {
        ...
        document.getElementById('favoritediv').innerHTML = "<img src='/Searching.gif' style='padding-left: 5px;'>\n";
    ...
    function showreply(id)
    {
        ...
        newelement.innerHTML = "<div style='float: left; width: 100%; padding-top: 20px;'><form id='replyform' name='replyform' method='post' action='../validatepostcommentreply.php'><input type='hidden' id='childof' name='childof' value='" + replyid + "'><input type='hidden' id='artworkid' name='artworkid' value='" + globalArtworkId + "'><p style='float: left; width: 100%; font: 8pt arial; font-weight: bold;'>Post Reply</p><div style='float: left; width: 100%; padding-top: 5px;'><textarea id='reply' name='reply' style='float: left; width: 290px; padding: 5px; font: 10pt arial;'></textarea></div><div style='float: left; width: 100%; padding-top: 10px;'><a class='button' href='javascript: submitreply();'><span>Reply</span></a></div></form></div>";
    ...
    {
        document.getElementById('submitnewkeywordsdiv').innerHTML = "<img src='/Searching.gif' style='float: left;'>";
    ...
    {
        document.getElementById('submitnewfaakeywordsdiv').innerHTML = "<img src='/Searching.gif' style='float: left;'>";
    ...
    function addfavoritetofolder(favoriteid)
    {
        ...
        document.getElementById('messageaddfavoritetofolderdiv').innerHTML = "<div style='float: left; width: 100%; padding-top: 15px; padding-bottom: 15px; text-align: center;'><img src='../Searching.gif'></div>\n";
    ...
    {
        document.getElementById('tagdiv').innerHTML = "<img src='/Searching.gif' style='float: left;'>";
    ...
    function createForegroundAndBackgroundDiv()
    {
        if(!document.getElementById('foregrounddiv') || !document.getElementById('backgrounddiv'))
        {
            ...
            {
                newdiv = document.createElement('div');
                cssstyle = 'position: fixed; z-index: 5001; left: 0px; top: 0px; box-sizing: border-box; width: 780px; min-height: 50px; padding: 0px; overflow: auto; padding: 25px; border: 15px solid #666666; background-color: #FFFFFF; visibility: hidden; box-shadow: 0px 0px 50px #000000;';
