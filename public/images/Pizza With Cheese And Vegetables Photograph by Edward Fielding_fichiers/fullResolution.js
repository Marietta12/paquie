    ...
    {   
        ...
        if(locationflag == 1)
        {
            ...
            selection.innerHTML = "<div style='float: left; width: 350px; height: 20px; padding: 15px; background-color: #FFFFFF; border: 1px solid #666666; border-radius: 6px; box-shadow: 0px 0px 20px #444444;'><p style='float: left; width: 170px; padding-top: 4px; overflow: hidden; font: 8pt arial; color: #444444;'>Loading Full-Resolution Preview</p><img src='../Searching.gif' style='float: left;'></div>";
