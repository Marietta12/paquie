...
@section('content_header')
    ...
    <a class="btn btn-primary header-button" href="{{ route('command.create') }}"> <i class="fa fa-plus"></i> Ajout</a>
@stop
    ...
    <section class="user-list">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <table id="listcommand" class="table table-bordered table-hover">
                            <thead>
                            <tr>
...
@section('js')
    ...
    {!! Html::script('js/admin/listCommand.js') !!}
