...
@section('content_header')
    ...
    <a class="btn btn-primary header-button" href="{{ route('order_product.create') }}"> <i class="fa fa-plus"></i> Ajout</a>
@stop
    ...
    <section class="user-list">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <table id="listOrderProduct" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>Ordre de produit</th>
                                <th>Id de produit</th>
                                <th>Quantité</th>
                                <th>Prix</th>
                                <th>Sous total</th>
...
@section('js')
    ...
    {!! Html::script('js/admin/listOrderProduct.js') !!}
